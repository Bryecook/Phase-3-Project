...
Question.create(difficulty: "easy", game_id: Game.first.id, body: "Where did Spongebob work?", answer: "The Krusty Krab", choices: ["The Chum Bucket", "Weenie Hut","The Krusty Krab", "Golden Loaf" ])
